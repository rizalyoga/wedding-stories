        ...
        <div className="container">
          <div className="text-box">
            ...
            <p style={{ fontSize: "1.2rem" }}>
              Wedding Stories is a comprehensive and inspiring wedding directory
              and marketplace that helps connect wedding organizers with
              brides-to-be across Indonesia.
            </p>
