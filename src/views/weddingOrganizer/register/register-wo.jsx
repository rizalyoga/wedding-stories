        ...
        <Container>
          <Row>
            <Col md={8} sm={12} className="">
              ...
              <hr className="strip" />
              <p className="description-text">Join more than 20,000 wedding vendors from 70 countries who have connected with millions of engaged couples through Bridestory.</p>
            </Col>
            <Col md={4} sm={12}>
              <Form onSubmit={handleSubmit}>
                <Row className="mt-5 pt-5">
                  <Form.Group as={Col} md="12" controlId="validationCustomUsername">
                    ...
                    <Form.Control type="text" placeholder="Bussiness name" aria-describedby="inputGroupPrepend" onChange={(e) => setField("name", e.target.value)} required isInvalid={!!errors.name} />
                ...
                <Form.Group className="mb-12 mt-3">
                  <Form.Check className="title-form" required label="Agree to terms and conditions" feedback="You must agree before submitting." feedbackType="invalid" />
                </Form.Group>
                <Button className="col-12 mt-3 mb-3 btn-submit" variant="primary" onClick={handleSubmit}>
                  Register
                </Button>
              </Form>
              <h7 className="mt-3">
